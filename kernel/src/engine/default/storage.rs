...
/// users to provide their own custom URL handler to plug new [object_store::ObjectStore] instances
/// into delta-kernel, which is used by [store_from_url_opts] to parse the URL.
